...
import { Sun, Moon, Mail, Shield, Lock, GraduationCap, Users, CheckCircle, CreditCard, Loader2 } from 'lucide-react';
...
const Login: React.FC = () => {
  ...
  const handleZkLoginCallback = async (jwt: string) => {
    try {
      ...
      const userEmail = (result.decodedJwt as any)?.email || email || `${result.zkLoginAddress.slice(0, 8)}@zklogin.user`;
