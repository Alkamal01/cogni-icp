...
import { X, BookOpen, Clock, Users, Plus, ArrowRight, MessageSquare } from 'lucide-react';
...
interface Material {
  id: string;
  name: string;
  type: 'pdf' | 'doc' | 'ppt' | 'image' | 'video' | 'link' | 'other';
  size?: string;
  uploadedBy: string;
  uploadedAt: Date;
  tags: string[];
...
const MaterialsRepository: React.FC<MaterialsRepositoryProps> = ({
  isOpen,
  onClose,
  groupId,
  groupName
                ...
                <div className="flex space-x-4">
                  <div className="relative flex-1 min-w-[200px]">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-2 border border-gray-300 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary-500 dark:focus:ring-primary-400"
                ...
                {filteredMaterials.length === 0 ? (
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {filteredMaterials.map(material => (
                      <div
                        key={material.id}
                        className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-shadow p-4 relative group"
                      >
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 resize-none"
