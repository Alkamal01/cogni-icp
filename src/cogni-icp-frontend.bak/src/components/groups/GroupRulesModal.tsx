...
const GroupRulesModal: React.FC<GroupRulesModalProps> = ({ 
  isOpen, 
  onClose, 
  onAccept,
  groupName,
    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50">
        <motion.div
          ...
          className="bg-white dark:bg-gray-900 rounded-xl shadow-xl w-full max-w-xl max-h-[90vh] overflow-y-auto"
        >
