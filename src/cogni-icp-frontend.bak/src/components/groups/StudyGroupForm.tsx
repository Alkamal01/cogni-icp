...
const StudyGroupForm: React.FC<StudyGroupFormProps> = ({ isOpen, onClose, onSubmit }) => {
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                className="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-primary-500 dark:focus:ring-primary-400"
                placeholder="E.g. Calculus, Machine Learning, Web Development"
              />
            </div>
            ...
            <div>
              ...
              <div className="flex space-x-4">
                <div 
                  ...
                  className={`flex-1 p-4 border rounded-lg flex flex-col items-center cursor-pointer transition-all ${
                ...
                >
                  <Users className={`h-6 w-6 mb-2 ${
                    formData.privacy === 'public' ? 'text-primary-600 dark:text-primary-400' : 'text-gray-500 dark:text-gray-400'
                  }`} />
                ...
                >
                  <Lock className={`h-6 w-6 mb-2 ${
                    formData.privacy === 'private' ? 'text-primary-600 dark:text-primary-400' : 'text-gray-500 dark:text-gray-400'
                  }`} />
            ...
            {formData.privacy === 'private' && (
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-primary-500 dark:focus:ring-primary-400"
                  placeholder="Create an access key for your group"
                />
            ...
            <div>
              ...
              <div className="flex items-center space-x-2">
                <input
                  ...
                  className="flex-1 px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-primary-500 dark:focus:ring-primary-400"
              ...
              {formData.tags.length > 0 && (
                <div className="flex flex-wrap gap-2 mt-3">
                  {formData.tags.map((tag) => (
                    <span 
                      key={tag}
                      className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-primary-100 text-primary-800 dark:bg-primary-900/40 dark:text-primary-300"
                    >
                      {tag}
                      <button
                        type="button"
