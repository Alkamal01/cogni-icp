...
class BlockchainService {
    ...
    async completeTaskOnBlockchain(data) {
        try {
    ...
    async createTaskOnBlockchain(data) {
        try {
    ...
    async createAchievementOnBlockchain(data) {
        try {
    ...
    async validateWalletAddress(data) {
        try {
    ...
    async setupContractAddresses(data) {
        try {
    ...
    async getUserBlockchainAchievements() {
        try {
    ...
    async syncTaskCompletionToBlockchain(taskPublicId, proofData) {
        try {
