...
const Login = () => {
    ...
    const handleZkLoginCallback = async (jwt) => {
        try {
            ...
            const userEmail = result.decodedJwt?.email || formData.email || `${result.zkLoginAddress.slice(0, 8)}@zklogin.user`;
            ...
            <form className="mt-6 space-y-6" onSubmit={handleSubmit}>
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="mt-1 relative rounded-md shadow-sm">
                    ...
                    <input id="password" name="password" type={showPassword ? "text" : "password"} autoComplete="current-password" required value={formData.password} onChange={(e) => setFormData({ ...formData, password: e.target.value })} className="block w-full pl-10 pr-10 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-primary-500 focus:border-primary-500 sm:text-sm" placeholder="••••••••"/>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <input id="remember-me" name="remember-me" type="checkbox" className="h-4 w-4 text-primary-600 focus:ring-primary-500 border-gray-300 rounded dark:border-gray-600 dark:bg-gray-700"/>
