...
import { User, Bell, Brain, Shield, AlertCircle, MessageSquare, Book, X } from 'lucide-react';
...
const Settings = () => {
    ...
    const handleArrayPreferenceToggle = (arrayName, item, setter) => {
        setter(prev => {
    ...
    const handleLearningPreferencesSubmit = async (e) => {
        e.preventDefault();
        try {
    ...
    const handleAccessibilitySubmit = async (e) => {
        e.preventDefault();
        try {
    ...
    const handleToggleTwoFactor = async (enable) => {
        try {
    ...
    const handleTerminateAllSessions = async () => {
        if (window.confirm('This will terminate all sessions except your current one. Continue?')) {
            try {
                ...
                setSecuritySettings(prev => ({
                    ...prev,
                    activeSessions: prev.activeSessions.filter(session => session.id === currentSessionId)
                }));
          ...
          <div className="col-span-12 md:col-span-3">
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4">
              <nav className="space-y-2">
                <button onClick={() => setActiveTab('profile')} className={`w-full flex items-center space-x-3 px-4 py-2 rounded-lg transition-colors ${activeTab === 'profile'
            ? 'bg-primary-50 dark:bg-primary-900/30 text-primary-600 dark:text-primary-400'
            : 'text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700/50'}`}>
                  <User className="h-5 w-5"/>
                  <span>Profile Settings</span>
                </button>
                <button onClick={() => setActiveTab('learning')} className={`w-full flex items-center space-x-3 px-4 py-2 rounded-lg transition-colors ${activeTab === 'learning'
            ? 'bg-primary-50 dark:bg-primary-900/30 text-primary-600 dark:text-primary-400'
            : 'text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700/50'}`}>
                  <Brain className="h-5 w-5"/>
                  <span>Learning Preferences</span>
                </button>
                <button onClick={() => setActiveTab('security')} className={`w-full flex items-center space-x-3 px-4 py-2 rounded-lg transition-colors ${activeTab === 'security'
            ? 'bg-primary-50 dark:bg-primary-900/30 text-primary-600 dark:text-primary-400'
            : 'text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700/50'}`}>
                  <Shield className="h-5 w-5"/>
                  <span>Security</span>
                </button>
                <button onClick={() => setActiveTab('accessibility')} className={`w-full flex items-center space-x-3 px-4 py-2 rounded-lg transition-colors ${activeTab === 'accessibility'
            ? 'bg-primary-50 dark:bg-primary-900/30 text-primary-600 dark:text-primary-400'
            : 'text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700/50'}`}>
                  <Book className="h-5 w-5"/>
                  <span>Accessibility</span>
                </button>
                <button onClick={() => setActiveTab('ai')} className={`w-full flex items-center space-x-3 px-4 py-2 rounded-lg transition-colors ${activeTab === 'ai'
            ? 'bg-primary-50 dark:bg-primary-900/30 text-primary-600 dark:text-primary-400'
            : 'text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700/50'}`}>
                  <MessageSquare className="h-5 w-5"/>
                  <span>AI Assistant</span>
                </button>
                <button onClick={() => setActiveTab('privacy')} className={`w-full flex items-center space-x-3 px-4 py-2 rounded-lg transition-colors ${activeTab === 'privacy'
            ? 'bg-primary-50 dark:bg-primary-900/30 text-primary-600 dark:text-primary-400'
            : 'text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700/50'}`}>
            ...
            {activeTab === 'profile' ? (<>
                  ...
                  <div className="p-6">
                    ...
                    <form onSubmit={handleProfileSubmit} className="space-y-6">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                          ...
                          <input type="text" value={profileData.name} onChange={(e) => setProfileData({ ...profileData, name: e.target.value })} disabled={!isEditing} className="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white"/>
                        </div>
                        <div>
                          <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                            Email
                          </label>
                          <input type="email" value={profileData.email} onChange={(e) => setProfileData({ ...profileData, email: e.target.value })} disabled={!isEditing} className="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white"/>
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <textarea value={profileData.bio} onChange={(e) => setProfileData({ ...profileData, bio: e.target.value })} disabled={!isEditing} rows={4} className="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white"/>
                      </div>
                      ...
                      <div>
                        ...
                        <div className="flex items-center space-x-4">
                          <div className="relative w-20 h-20 rounded-full border-2 border-dashed border-gray-300 dark:border-gray-700 flex items-center justify-center overflow-hidden bg-gray-50 dark:bg-gray-900">
                            {avatarPreview || profileData.avatar_url ? (<img src={avatarPreview || profileData.avatar_url} alt="Profile" className="w-full h-full object-cover rounded-full" onError={(e) => {
                    const target = e.target;
                    target.style.display = 'none';
                    target.nextElementSibling?.classList.remove('hidden');
                }}/>) : (<User className="w-8 h-8 text-gray-400 dark:text-gray-600"/>)}
                            {!avatarPreview && !profileData.avatar_url && (<div className="absolute inset-0 flex items-center justify-center bg-gray-100 dark:bg-gray-800 rounded-full">
                                <User className="w-8 h-8 text-gray-400 dark:text-gray-600"/>
                              </div>)}
                          </div>
                    ...
                    if (file) {
                        ...
                        reader.readAsDataURL(file);
                              ...
                              {avatarFile && (<button type="button" onClick={() => {
                        setAvatarFile(null);
                        setAvatarPreview(null);
                      ...
                      {isEditing && (<div className="space-y-4">
                          <div>
                            ...
                            <input type="password" value={profileData.currentPassword} onChange={(e) => setProfileData({ ...profileData, currentPassword: e.target.value })} className="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white"/>
                          </div>
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                              ...
                              <input type="password" value={profileData.newPassword} onChange={(e) => setProfileData({ ...profileData, newPassword: e.target.value })} className="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white"/>
                            </div>
                            <div>
                              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                                Confirm New Password
                              </label>
                              <input type="password" value={profileData.confirmPassword} onChange={(e) => setProfileData({ ...profileData, confirmPassword: e.target.value })} className="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white"/>
                            </div>
                          </div>
                        </div>)}
                ...
                <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm">
                  <div className="p-6">
                    ...
                    <div className="space-y-4">
                      {Object.entries(profileData.notifications).map(([key, value]) => (<div key={key} className="flex items-center justify-between">
                    ...
                    <form onSubmit={handleLearningPreferencesSubmit} className="space-y-6">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                          ...
                          <select value={learningPreferences.learningStyle} onChange={(e) => setLearningPreferences(prev => ({ ...prev, learningStyle: e.target.value }))} className="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white">
                        ...
                        <div>
                          ...
                          <select value={learningPreferences.educationalBackground} onChange={(e) => setLearningPreferences(prev => ({ ...prev, educationalBackground: e.target.value }))} className="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white">
                            {educationalBackgrounds.map(background => (<option key={background} value={background}>
                        ...
                        <div>
                          ...
                          <select value={learningPreferences.difficultyLevel} onChange={(e) => setLearningPreferences(prev => ({
                ...prev,
                difficultyLevel: e.target.value
                        ...
                        <div>
                          ...
                          <input type="number" min="0.5" max="12" step="0.5" value={learningPreferences.dailyGoalHours} onChange={(e) => setLearningPreferences(prev => ({
                ...prev,
                      ...
                      <div className="border-t border-gray-200 dark:border-gray-700 pt-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          <div>
                            ...
                            <select value={learningPreferences.aiInteractionLevel} onChange={(e) => setLearningPreferences(prev => ({
                ...prev,
                aiInteractionLevel: e.target.value
            }))} className="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white">
                          ...
                          <div>
                            <div className="flex items-center justify-between mb-2">
                              ...
                              <div className="relative inline-block w-10 mr-2 align-middle select-none">
                                <input type="checkbox" name="adaptive-learning" id="adaptive-learning" checked={learningPreferences.adaptiveLearningEnabled} onChange={(e) => setLearningPreferences(prev => ({
                ...prev,
                adaptiveLearningEnabled: e.target.checked
            }))} className="sr-only"/>
                                <label htmlFor="adaptive-learning" className={`block overflow-hidden h-6 rounded-full cursor-pointer ${learningPreferences.adaptiveLearningEnabled
                ? 'bg-primary-600'
                : 'bg-gray-300 dark:bg-gray-700'}`}>
                                  <span className={`block h-6 w-6 rounded-full bg-white shadow transform transition-transform ${learningPreferences.adaptiveLearningEnabled ? 'translate-x-4' : 'translate-x-0'}`}/>
                                </label>
                              </div>
                            </div>
                      ...
                      <div className="border-t border-gray-200 dark:border-gray-700 pt-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
                          <div>
                            ...
                            <select value={learningPreferences.preferredLanguage} onChange={(e) => setLearningPreferences(prev => ({
                ...prev,
                preferredLanguage: e.target.value
            }))} className="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white">
                              {availableLanguages.map(language => (<option key={language.code} value={language.name}>
                                  {language.name}
                                </option>))}
                            </select>
                          </div>
                          ...
                          <div>
                            <div className="flex items-center justify-between mb-2">
                              ...
                              <div className="relative inline-block w-10 mr-2 align-middle select-none">
                                <input type="checkbox" name="content-localization" id="content-localization" checked={learningPreferences.contentLocalization} onChange={(e) => setLearningPreferences(prev => ({
                ...prev,
                contentLocalization: e.target.checked
            }))} className="sr-only"/>
                                <label htmlFor="content-localization" className={`block overflow-hidden h-6 rounded-full cursor-pointer ${learningPreferences.contentLocalization
                ? 'bg-primary-600'
                : 'bg-gray-300 dark:bg-gray-700'}`}>
                                  <span className={`block h-6 w-6 rounded-full bg-white shadow transform transition-transform ${learningPreferences.contentLocalization ? 'translate-x-4' : 'translate-x-0'}`}/>
                                </label>
                              </div>
                            </div>
                            <p className="text-xs text-gray-500 dark:text-gray-400">
                ...
                .map(language => (<div key={language.code} className="flex items-center">
                                  <input type="checkbox" id={`lang-${language.code}`} checked={learningPreferences.secondaryLanguages.includes(language.name)} onChange={() => {
                    setLearningPreferences(prev => {
                        ...
                        return { ...prev, secondaryLanguages: updated };
                                  ...
                                  <label htmlFor={`lang-${language.code}`} className="ml-2 text-sm text-gray-700 dark:text-gray-300">
                                    {language.name}
                                  </label>
                                </div>))}
                          </div>
                        ...
                        <div className="mt-4">
                          ...
                          <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 max-h-32 overflow-y-auto p-2 border border-gray-200 dark:border-gray-700 rounded-lg">
                            {availableCulturalContexts.map(context => (<div key={context} className="flex items-center">
                                <input type="checkbox" id={`context-${context}`} checked={learningPreferences.culturalContexts.includes(context)} onChange={() => {
                    setLearningPreferences(prev => {
                        ...
                        return { ...prev, culturalContexts: updated };
                                ...
                                <label htmlFor={`context-${context}`} className="ml-2 text-sm text-gray-700 dark:text-gray-300">
                                  {context}
                                </label>
                              </div>))}
                          </div>
                      ...
                      <div className="border-t border-gray-200 dark:border-gray-700 pt-6">
                        ...
                        <div>
                          ...
                          <div className="grid grid-cols-2 gap-2 max-h-32 overflow-y-auto p-2 border border-gray-200 dark:border-gray-700 rounded-lg">
                            {commonLearningGoals.map(goal => (<div key={goal} className="flex items-center">
                                <input type="checkbox" id={`goal-${goal}`} checked={learningPreferences.learningGoals.includes(goal)} onChange={() => {
                    setLearningPreferences(prev => {
                        ...
                        <div className="mt-4">
                          ...
                          <div className="flex flex-wrap gap-2 mb-2">
                            {learningPreferences.topicsOfInterest.map(topic => (<span key={topic} className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-primary-100 text-primary-800 dark:bg-primary-900 dark:text-primary-300">
                                {topic}
                                <button type="button" onClick={() => handleTopicRemove(topic)} className="ml-1.5 inline-flex items-center justify-center h-4 w-4 rounded-full text-primary-400 hover:text-primary-600 dark:hover:text-primary-300">
                                  <X className="h-3 w-3"/>
                          ...
                          <div className="flex">
                            <input type="text" placeholder="Add a topic..." value={newTopic} onChange={(e) => setNewTopic(e.target.value)} onKeyPress={(e) => {
              ...
              </>) : activeTab === 'security' ? (<div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm">
                <div className="p-6">
                  <h2 className="text-xl font-semibold text-gray-900 dark:text-white flex items-center mb-6">
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      <div className="flex items-center justify-between">
                        ...
                        <Button variant={securitySettings.twoFactorEnabled ? "outline" : "primary"} onClick={() => handleToggleTwoFactor(!securitySettings.twoFactorEnabled)}>
                    ...
                    <div>
                      ...
                      <div className="space-y-4">
                        {securitySettings.activeSessions.map((session, index) => (<div key={index} className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                            <div>
                    ...
                    <div>
                      ...
                      <div className="space-y-4">
                        {securitySettings.loginHistory.map((login, index) => (<div key={index} className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                            <div>
                            ...
                            <span className={`px-2 py-1 text-xs font-medium rounded-full ${login.status === 'success'
              ...
              </div>) : activeTab === 'accessibility' ? (<div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm">
                <div className="p-6">
                  <h2 className="text-xl font-semibold text-gray-900 dark:text-white flex items-center mb-6">
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <select value={accessibilitySettings.fontSize} onChange={(e) => setAccessibilitySettings(prev => ({
                ...prev,
                fontSize: e.target.value
                    ...
                    <div>
                      ...
                      <select value={accessibilitySettings.contrast} onChange={(e) => setAccessibilitySettings(prev => ({
                ...prev,
                contrast: e.target.value
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center justify-between">
                        ...
                        <Button variant={accessibilitySettings.reduceMotion ? "primary" : "outline"} onClick={() => setAccessibilitySettings(prev => ({
                ...prev,
                reduceMotion: !prev.reduceMotion
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <Button variant={accessibilitySettings.screenReader ? "primary" : "outline"} onClick={() => setAccessibilitySettings(prev => ({
                ...prev,
                screenReader: !prev.screenReader
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <Button variant={accessibilitySettings.colorBlindMode ? "primary" : "outline"} onClick={() => setAccessibilitySettings(prev => ({
                ...prev,
              ...
              </div>) : activeTab === 'ai' ? (<div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm">
                <div className="p-6">
                  <h2 className="text-xl font-semibold text-gray-900 dark:text-white flex items-center mb-6">
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <select value={aiSettings.interactionStyle} onChange={(e) => setAiSettings(prev => ({
                ...prev,
                interactionStyle: e.target.value
            }))} className="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800">
                    ...
                    <div>
                      ...
                      <select value={aiSettings.responseLength} onChange={(e) => setAiSettings(prev => ({
                ...prev,
                responseLength: e.target.value
                    ...
                    <div>
                      ...
                      <select value={aiSettings.modelPreference} onChange={(e) => setAiSettings(prev => ({
                ...prev,
                modelPreference: e.target.value
                    ...
                    <div>
                      ...
                      <textarea value={aiSettings.customInstructions} onChange={(e) => setAiSettings(prev => ({
                ...prev,
                customInstructions: e.target.value
            }))} rows={4} className="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800" placeholder="Add any specific instructions for the AI assistant..."/>
                    </div>
                  </div>
                </div>
              </div>) : activeTab === 'privacy' ? (<div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm">
                <div className="p-6">
                  <h2 className="text-xl font-semibold text-gray-900 dark:text-white flex items-center mb-6">
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <select value={privacySettings.profileVisibility} onChange={(e) => setPrivacySettings(prev => ({
                ...prev,
                profileVisibility: e.target.value
                    ...
                    <div>
                      ...
                      <select value={privacySettings.activitySharing} onChange={(e) => setPrivacySettings(prev => ({
                ...prev,
                activitySharing: e.target.value
            }))} className="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Button variant={privacySettings.allowConnectionRequests ? "primary" : "outline"} onClick={() => setPrivacySettings(prev => ({
                ...prev,
                allowConnectionRequests: !prev.allowConnectionRequests
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <Button variant={privacySettings.dataUsageConsent.learningAnalytics ? "primary" : "outline"} onClick={() => setPrivacySettings(prev => ({
                ...prev,
                dataUsageConsent: {
                    ...
                    learningAnalytics: !prev.dataUsageConsent.learningAnalytics
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <Button variant={privacySettings.dataUsageConsent.aiTraining ? "primary" : "outline"} onClick={() => setPrivacySettings(prev => ({
                ...prev,
                dataUsageConsent: {
                    ...prev.dataUsageConsent,
                    aiTraining: !prev.dataUsageConsent.aiTraining
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <Button variant={privacySettings.dataUsageConsent.thirdPartySharing ? "primary" : "outline"} onClick={() => setPrivacySettings(prev => ({
                ...prev,
                dataUsageConsent: {
                    ...prev.dataUsageConsent,
