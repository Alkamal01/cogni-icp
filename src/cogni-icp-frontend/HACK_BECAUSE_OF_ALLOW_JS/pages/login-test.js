...
const LoginTestPage = () => {
    ...
    return (<div className="min-h-screen bg-gray-100 dark:bg-gray-900 py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className={`mt-1 text-sm font-semibold ${tokenStatus === 'Valid token'
