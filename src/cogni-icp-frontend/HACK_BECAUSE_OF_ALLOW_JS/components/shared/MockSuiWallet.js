      ...
      <div className="space-y-4">
        ...
        <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
          <div className="flex items-center justify-between">
            ...
            <button onClick={copyToClipboard} className="flex items-center space-x-1 text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 transition-colors">
              {copied ? (<>
        ...
        <div className="flex space-x-2 pt-2">
          <button onClick={() => window.open('https://suiexplorer.com/address/' + walletAddress, '_blank')} className="flex-1 flex items-center justify-center space-x-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium py-2 px-4 rounded-md transition-colors">
