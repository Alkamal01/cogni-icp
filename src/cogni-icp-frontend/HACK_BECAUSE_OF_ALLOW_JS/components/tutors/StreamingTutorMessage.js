...
export const StreamingTutorMessage = ({ sessionId, onComplete, onError, }) => {
    const { isConnected, isError, status, messages, } = useStreamingTutor(sessionId);
    ...
    return (<>
      {renderContent()}
      {showTypingIndicator && (<div className="flex items-center space-x-1 mt-2">
