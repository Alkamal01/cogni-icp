...
// Custom SVG icons
const MicIcon = ({ className }) => (<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M12 1a3 3 0 0 0-3 3v8a3 3 0 0 0 6 0V4a3 3 0 0 0-3-3z"></path>
    <path d="M19 10v2a7 7 0 0 1-14 0v-2"></path>
    <line x1="12" y1="19" x2="12" y2="23"></line>
    <line x1="8" y1="23" x2="16" y2="23"></line>
  </svg>);
const MicOffIcon = ({ className }) => (<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
const VolumeIcon = ({ className }) => (<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon>
    <path d="M15.54 8.46a5 5 0 0 1 0 7.07"></path>
    <path d="M19.07 4.93a10 10 0 0 1 0 14.14"></path>
  </svg>);
const VolumeXIcon = ({ className }) => (<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon>
    <line x1="23" y1="9" x2="17" y2="15"></line>
    <line x1="17" y1="9" x2="23" y2="15"></line>
  </svg>);
const VoiceChat = ({ isOpen, onClose, onSendMessage, tutorName, tutorId, sessionId, tutorAvatarUrl }) => {
    ...
    const processAudioMessage = async (audioBlob) => {
        ...
        try {
            ...
            if (result.success) {
                ...
                await playAudioResponse(result.response_text, result.audio_data, result.use_browser_tts);
    ...
    const playAudioResponse = async (text, audioData, useBrowserTTS = false) => {
        ...
        try {
            if (audioData && !useBrowserTTS) {
                ...
                if ('speechSynthesis' in window) {
                    ...
                    const preferredVoice = voices.find(voice => voice.lang.includes('en') && voice.name.includes('Google')) || voices.find(voice => voice.lang.includes('en'));
                    if (preferredVoice) {
    ...
    return (<div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-8 max-w-2xl w-full mx-4 relative">
        ...
        <button onClick={() => {
            ...
            stopAllAudio();
            onClose();
        }} className="absolute top-4 right-4 p-2 rounded-full bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors" aria-label="Close voice chat">
        ...
        <div className="flex flex-col items-center justify-center mb-6">
          <div className="relative flex items-center justify-center mb-6" style={{ width: 'min(280px, 60vw)', height: 'min(280px, 60vw)' }}>
            ...
            <svg width="100%" height="100%" viewBox="0 0 280 280" className="absolute top-0 left-0">
              ...
              <circle cx="140" cy="140" r="120" fill="none" stroke="url(#waveGradient)" strokeWidth={isTutorSpeaking ? 10 : 5} strokeDasharray="25 10 10 10 20 10 10 10" strokeDashoffset={isTutorSpeaking ? 0 : 35}>
                <animateTransform attributeName="transform" type="rotate" from="0 140 140" to="360 140 140" dur={isTutorSpeaking ? "1s" : "3s"} repeatCount="indefinite"/>
              </circle>
            </svg>
            ...
            <div className="rounded-full overflow-hidden shadow-lg border-4 border-white dark:border-gray-900" style={{ width: 'min(180px, 40vw)', height: 'min(180px, 40vw)', zIndex: 2, background: '#222' }}>
              {tutorAvatarUrl ? (<img src={tutorAvatarUrl} alt={tutorName} className="w-full h-full object-cover"/>) : (<div className="w-full h-full flex items-center justify-center bg-gray-200 dark:bg-gray-700">
          ...
          <div className="flex items-center space-x-2 mb-6">
            {isRecording && (<div className="flex items-center space-x-2 text-red-600 dark:text-red-400">
                <div className="w-4 h-4 bg-red-500 rounded-full animate-pulse"></div>
                <span className="text-base font-medium">Recording</span>
              </div>)}
            {isTutorSpeaking && (<div className="flex items-center space-x-2 text-blue-600 dark:text-blue-400">
