...
const HeroSection = () => {
    ...
    return (<section className="relative bg-gradient-to-br from-gray-50 to-blue-50 dark:from-gray-900 dark:to-blue-900/95 min-h-screen flex flex-col justify-center overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 lg:gap-16 items-center">
          ...
          <motion.div initial={{ opacity: 0, x: -50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }} className="flex flex-col justify-center text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <motion.button onClick={handleGetStarted} className="bg-blue-600 hover:bg-blue-700 text-white font-semibold px-8 py-3 rounded-lg transition-all duration-200 flex items-center justify-center group shadow-lg hover:shadow-xl" whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                Start Your Journey
                <ArrowRight className="ml-2 h-5 w-5 transition-transform group-hover:translate-x-1"/>
              </motion.button>
              
              <motion.button onClick={handleLearnMore} className="border-2 border-blue-600 text-blue-600 hover:bg-blue-600 hover:text-white font-semibold px-8 py-3 rounded-lg transition-all duration-200" whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                Learn More
              </motion.button>
            </div>
          </motion.div>
          ...
          <motion.div initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.8, delay: 0.2 }} className="relative flex justify-center lg:justify-center mt-12 lg:mt-0">
            {/* Main Circle */}
            <div className="relative w-72 h-72 sm:w-80 sm:h-80 lg:w-[28rem] lg:h-[28rem]">
              {/* Background circles with pulsing animation */}
              <motion.div className="absolute inset-0" animate={{ scale: [1, 1.02, 1] }} transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }}>
              ...
              <motion.div className="absolute inset-6" animate={{ scale: [1, 1.02, 1] }} transition={{ duration: 3.5, repeat: Infinity, ease: "easeInOut", delay: 0.5 }}>
              ...
              <motion.div className="absolute inset-12" animate={{ scale: [1, 1.02, 1] }} transition={{ duration: 4.5, repeat: Infinity, ease: "easeInOut", delay: 0.2 }}>
              ...
              {/* AI Tutors */}
              <motion.div className="absolute top-4 right-0 sm:top-6 sm:-right-4 flex items-center space-x-2" animate={{ y: [0, -8, 0] }} transition={{ duration: 3.5, repeat: Infinity, ease: "easeInOut" }}>
              ...
              {/* Study Groups */}
              <motion.div className="absolute bottom-4 left-0 sm:bottom-6 sm:-left-4 flex items-center space-x-2" animate={{ y: [0, 8, 0] }} transition={{ duration: 4, repeat: Infinity, ease: "easeInOut", delay: 0.5 }}>
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-white dark:bg-gray-800 rounded-full shadow-xl flex items-center justify-center border border-gray-100 dark:border-gray-700">
              ...
              {/* Gamified Learning */}
              <motion.div className="absolute top-8 left-0 sm:top-12 sm:-left-10 flex items-center space-x-2" animate={{ y: [0, -6, 0], x: [0, 4, 0] }} transition={{ duration: 3.8, repeat: Infinity, ease: "easeInOut", delay: 0.2 }}>
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-white dark:bg-gray-800 rounded-full shadow-xl flex items-center justify-center border border-gray-100 dark:border-gray-700">
              ...
              {/* Learning Paths */}
              <motion.div className="absolute bottom-8 right-0 sm:bottom-12 sm:-right-10 flex items-center space-x-2" animate={{ y: [0, 6, 0], x: [0, -4, 0] }} transition={{ duration: 3.6, repeat: Infinity, ease: "easeInOut", delay: 0.35 }}>
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-white dark:bg-gray-800 rounded-full shadow-xl flex items-center justify-center border border-gray-100 dark:border-gray-700">
      ...
      {/* Scroll Indicator */}
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 1.5, duration: 0.8 }} className="absolute bottom-8 left-1/2 transform -translate-x-1/2" onClick={handleLearnMore}>
