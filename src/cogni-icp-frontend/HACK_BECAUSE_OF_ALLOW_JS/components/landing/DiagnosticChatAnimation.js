...
const DiagnosticChatAnimation = () => {
    ...
    return (<div className="w-full max-w-md mx-auto border border-gray-300 rounded-lg overflow-hidden flex flex-col h-[400px]">
      {/* Header */}
      <div className="bg-blue-600 text-white p-3 flex justify-between items-center">
        <h2 className="font-bold">Diagnostic Chat Demo</h2>
        <div className="flex gap-2">
          <button onClick={handleToggleAnimation} className="bg-blue-500 hover:bg-blue-700 text-white text-xs py-1 px-2 rounded">
      ...
      <div className="flex-grow bg-gray-100 p-3 overflow-y-auto flex flex-col space-y-3">
        {messages.map(message => (<div key={message.id} className={`flex ${message.isUser ? 'justify-end' : 'justify-start'}`}>
            <div className={`max-w-[80%] p-3 rounded-lg ${message.isUser
              ...
              {message.text}
              {message.typing && (<div className="flex space-x-1 mt-1">
