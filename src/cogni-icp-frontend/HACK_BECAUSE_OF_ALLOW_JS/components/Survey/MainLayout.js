...
function MainLayout() {
    ...
    return (<div className="flex h-screen bg-[#000053] text-gray-800">
      {/* Sidebar */}
      ...
      <div className="flex flex-col flex-1 md:ml-0"> {/* Removed md:ml-64 as sidebar is part of flex flow on md+ */}
        ...
        {showLogoutConfirm && (<div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
            <div className="bg-white p-4 rounded shadow-md">
              ...
              <div className="flex justify-end mt-4">
                ...
                <button className="bg-gray-300 px-4 py-2 rounded" onClick={() => setShowLogoutConfirm(false)}>
                  No
                </button>
              </div>
            </div>
...
const SidebarItem = ({ icon: Icon, label, onClick }) => (<div className="flex items-center space-x-2 p-2 hover:bg-gray-700 rounded cursor-pointer" onClick={onClick}>
    <Icon size={20}/>
    <span>{label}</span>
  </div>);
