...
const AnimatedConversation: React.FC = () => {
  ...
  return (
    <div className="w-full max-w-lg mx-auto border border-gray-300 rounded-lg overflow-hidden shadow-md flex flex-col bg-white dark:bg-gray-800">
      {/* Header */}
      ...
      <div className="p-3 border-t border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 flex">
        <input
          ...
          disabled
          className="flex-1 p-2 border border-gray-300 dark:border-gray-600 rounded-l-lg focus:outline-none dark:bg-gray-700 dark:text-gray-200"
        />
        <button 
          disabled
